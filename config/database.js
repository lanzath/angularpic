...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'lanza', 'lanzathm@gmail.com', 'secret', 'Thiago Lanza' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'lanza')
`;
...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'pombo', 'pombo@alurapic.com.br', 'secret', 'Pombo' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'pombo')
`;
